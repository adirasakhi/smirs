                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="logo">
                            <a href="{{ route('admin.admin.dashboard') }}">
                                <img src="{{ asset('mazer/assets/compiled/svg/logo.svg') }}" alt="Logo" srcset="">
                            </a>
                        </div>
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        @if(Auth::user()->role_id == 1) <!-- Admin -->
                            <li class="sidebar-item has-sub {{ Request::is('admin/users*') || Request::is('admin/divisions*') ? 'active' : '' }}">
                                ...
                                <ul class="submenu">
                                    ...
                                    <li class="submenu-item {{ Request::routeIs('admin.divisions.index') ? 'active' : '' }}">
                        ...
                        @if(Auth::user()->role_id == 1 || Auth::user()->role_id == 2) <!-- Admin or Gudang -->
                            <li class="sidebar-item has-sub {{ Request::is('admin/inventory*') || Request::is('admin/suppliers*') ? 'active' : '' }}">
                                <a href="#" class="sidebar-link">
                                    <i class="bi bi-boxes"></i>
                                    <span>Kelola Inventaris</span>
                                </a>
                                <ul class="submenu">
                                    <li class="submenu-item {{ Request::routeIs('admin.inventory.index') ? 'active' : '' }}">
                                        <a href="{{ route('admin.inventory.index') }}" class="submenu-link">Inventaris</a>
                                    </li>
                                    <li class="submenu-item {{ Request::routeIs('admin.suppliers.index') ? 'active' : '' }}">
                                        <a href="{{ route('admin.suppliers.index') }}" class="submenu-link">Pemasok</a>
                                    </li>
                                </ul>
                            </li>
                        @endif
                        ...
                        @if(Auth::user()->role_id == 1 || Auth::user()->role_id == 2) <!-- Admin or Gudang -->
                            <li class="sidebar-item has-sub {{ Request::is('admin/alokasi*') || Request::is('admin/locations*') ? 'active' : '' }}">
                                <a href="#" class="sidebar-link">
                                    <i class="bi bi-distribute-vertical"></i>
                                    <span>Alokasi Inventaris</span>
                                </a>
                                <ul class="submenu">
                                    <li class="submenu-item {{ Request::routeIs('admin.alokasi.index') ? 'active' : '' }}">
                                        <a href="{{ route('admin.alokasi.index') }}" class="submenu-link">Alokasi</a>
                                    </li>
                                    <li class="submenu-item {{ Request::routeIs('admin.locations.index') ? 'active' : '' }}">
                                        <a href="{{ route('admin.locations.index') }}" class="submenu-link">Lokasi</a>
                                    </li>
                                </ul>
                            </li>
                        @endif

                        @if(Auth::user()->role_id == 1 || Auth::user()->role_id == 2 || Auth::user()->role_id == 3 || Auth::user()->role_id == 4) <!-- Admin, Gudang, Kepala Inventaris, or Inventaris -->
